...
?>
 <section class="content">
    ...
    <div id="thumbGallery"
         ...
         data-nav_pagination="12"
         data-nav_show="<?php echo esc_attr($mwa_rglgallery_navtype); ?>"

         data-full_inline="false"
         data-full_inline_height="600"

         data-layout="grid"
         data-layout_cols="<?php echo esc_attr($mwa_rglgallery_galcol); ?>"
         data-layout_margin="10"
         data-layout_has_caption="true"
